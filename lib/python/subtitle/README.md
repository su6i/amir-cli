...
```bash
git clone https://github.com/su6i/ai-video-subtitle-generator.git
...
python video_multilang_translate.py video.mp4 -s en -t fa

# Translate to multiple languages
python video_multilang_translate.py video.mp4 -s en -t fa ar es

# Render video with embedded subtitles (with progress bar)
python video_multilang_translate.py video.mp4 -s en -t fa -r

# Force re-transcription
python video_multilang_translate.py video.mp4 -s en -t fa -f

# List all supported languages
python video_multilang_translate.py -l
```
